...
- Softmax generalizes to logistic regression just for N number of classes, meaning when N=2 this is the same as [[0-MachineLearning/0-CoursesPart1/MachineLearning/Logistic_regression]] 
