...
>![[Pasted image 20220603143845.png]]
>Consider 3 currencies: \$, C\$, and £ 
>– One dollar buys £ 0.7665 or C$ 1.3413
>– The exchange rate between UK pounds and Canadian dollars can be calculated from this information
> £0.7665 = C$ 1.3413 
> £1 = C$1.3413 / 0.7665 
> £1 = C\$1.7498 OR 
> C\$ 1 = £ 0.7665 / 1.3413 C$1 = £0.5715

- Appreciation is the increase in the value of a currency relative to other currencies 
- Depreciation is the decrease in the value of a currency relative to other currencies 

## Foreign exchange market 
- The market on which currencies of various nations are traded
- Flexible exchange rates are exchange rates that vary according to the supply and demand for the currency in foreign markets
- A fixed exchange rate is set by the official goverment policy, this can be independent or with agreement from other governments. Fixed rates can be set relative to currencies like the dollar, euro or even gold

## Real exchange rates 
- The real exchange rate is the price of the average good relative to the price of the average foreign good with prices expressed as a common currency  such as the dollar

>![[Pasted image 20220603145513.png]]
>![[Pasted image 20220603145326.png]]

- Example utility

>![[Pasted image 20220603145423.png]]

## Exchange rate influences 
- A high real exchange rate attracts more imports and make it difficult to export
- Real and nominal interest rates tend to move in the same direction
- A strong currency doesn't necessarily mean a strong economy, as context compared to other foreign currency also matters which can all be down in times such as a recession
